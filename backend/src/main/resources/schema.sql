...
ALTER TABLE IF EXISTS report_run ADD COLUMN IF NOT EXISTS closed_at TIMESTAMP;
ALTER TABLE IF EXISTS report_run ADD COLUMN IF NOT EXISTS closed_reason VARCHAR(500);
ALTER TABLE IF EXISTS report_run ADD COLUMN IF NOT EXISTS reopened_at TIMESTAMP;
